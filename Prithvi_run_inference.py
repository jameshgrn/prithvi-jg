...
def main(data_files: List[str], yaml_file_path: str, checkpoint: str, output_dir: str,
    ...
    img_size = params['model_args']['img_size']
    ...
    patch_size = params['model_args']['patch_size']
    embed_dim = params['model_args']['embed_dim']
    num_heads = params['model_args']['num_heads']
    tubelet_size = params['model_args']['tubelet_size']
    decoder_embed_dim = params['model_args']['decoder_embed_dim']
    decoder_num_heads = params['model_args']['decoder_num_heads']
    decoder_depth = params['model_args']['decoder_depth']

    mask_ratio = params['train_params']['mask_ratio'] if mask_ratio is None else mask_ratio
