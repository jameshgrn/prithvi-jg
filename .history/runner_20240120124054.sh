...
python Prithvi_run_inference.py --data_files t1.tif t2.tif t3.tif --yaml_file_path Prithvi_100M_.yaml --checkpoint /Prithvi_100.pth --output_dir /N/u/jhgearon/Quartz/prithvi_jg/output --mask_ratio 0.5
