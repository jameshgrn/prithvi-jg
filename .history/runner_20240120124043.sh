...
python Prithvi_run_inference.py --data_files t1.tif t2.tif t3.tif --yaml_file_path /path/to/yaml/Prithvi_100.yaml --checkpoint /Prithvi_100.pth --output_dir /N/u/jhgearon/Quartz/prithvi_jg/output --mask_ratio 0.5
