...
python Prithvi_run_inference.py --data_files $img_path --yaml_file_path /path/to/yaml/Prithvi_100.yaml --checkpoint /Prithvi_100.pth --output_dir /path/to/out/dir/ --mask_ratio 0.5
