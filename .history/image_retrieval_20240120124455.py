...
with rasterio.open(output_files[i], 'w', driver='GTiff', height=data['variable_name'].shape[1], width=data['variable_name'].shape[2], count=3, dtype=data['variable_name'].dtype) as dst:
